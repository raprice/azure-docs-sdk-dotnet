---
title: Azure Lab Services Management client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.LabServices, labservices
author: pallavit
ms.author: pallavit
ms.date: 09/15/2022
ms.topic: reference
...
---
# Azure Lab Services Management client library for .NET - version 1.0.0-alpha.20220915.1 
...
Install the Azure Lab Services management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.LabServices --prerelease
```
