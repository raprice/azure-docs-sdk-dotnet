---
title: Azure Automation Management client library for .NET
...
---
# Azure Automation Management client library for .NET - version 1.0.0-alpha.20220912.1 
...
Install the Azure Automation management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.Automation --prerelease
```
