---
title: Azure Data Box Management client library for .NET
...
ms.service: databox
---
# Azure Data Box Management client library for .NET - version 1.0.0-alpha.20220912.1 
...
Install the Azure Data Box management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.DataBox --prerelease
```
