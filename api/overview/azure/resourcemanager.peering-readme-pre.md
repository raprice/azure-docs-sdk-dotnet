---
title: Azure Peering Management client library for .NET
...
ms.service: peering
---
# Azure Peering Management client library for .NET - version 1.0.0-alpha.20220915.1 
...
Install the Azure Peering management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.Peering --prerelease
```
