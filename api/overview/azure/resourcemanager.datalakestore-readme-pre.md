---
title: Azure DataLake Store Management client library for .NET
...
---
# Azure DataLake Store Management client library for .NET - version 1.0.0-alpha.20220916.2 
...
```dotnetcli
dotnet add package Azure.ResourceManager.DataLakeStore --prerelease
```
