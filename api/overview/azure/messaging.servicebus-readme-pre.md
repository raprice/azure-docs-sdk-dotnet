...
---
# Azure Service Bus client library for .NET - version 7.11.0-alpha.20220913.1 
...
For detailed information about the failures represented by the `ServiceBusException` and other exceptions that may occur, please refer to [Service Bus messaging exceptions](/azure/service-bus-messaging/service-bus-messaging-exceptions).
