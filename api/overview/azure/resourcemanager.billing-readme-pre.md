---
title: Azure Billing Management client library for .NET
...
ms.service: billing
---
# Azure Billing Management client library for .NET - version 1.0.0-alpha.20220919.1 
...
```dotnetcli
dotnet add package Azure.ResourceManager.Billing --prerelease
```
