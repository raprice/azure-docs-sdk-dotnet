...
ms.service: monitor
---
# Azure Monitor Query client library for .NET - version 1.2.0-alpha.20220912.1 
...
- A [TokenCredential](/dotnet/api/azure.core.tokencredential?view=azure-dotnet) implementation, such as an [Azure Identity library credential type](/dotnet/api/overview/azure/Identity-readme#credential-classes).
...
[msdocs_apiref]: /dotnet/api/overview/azure/monitor/query?view=azure-dotnet
