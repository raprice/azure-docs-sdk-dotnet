---
title: Azure Subscription Management client library for .NET
...
---
# Azure Subscription Management client library for .NET - version 1.0.0-alpha.20220914.1 
...
Install the Azure Subscription management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.Subscription --prerelease
```
