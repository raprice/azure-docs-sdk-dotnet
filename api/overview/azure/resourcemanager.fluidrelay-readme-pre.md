---
title: Azure Fluid Relay Management client library for .NET
...
---
# Azure Fluid Relay Management client library for .NET - version 1.0.0-alpha.20220912.1 
...
Install the Azure Fluid Relay management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.FluidRelay --prerelease
```
