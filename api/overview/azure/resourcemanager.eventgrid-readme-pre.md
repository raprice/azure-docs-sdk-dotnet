---
title: Azure Event Grid Management client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.EventGrid, eventgrid
author: Kishp01
ms.author: kishp
ms.date: 09/17/2022
ms.topic: reference
...
---
# Azure Event Grid Management client library for .NET - version 1.0.0-alpha.20220916.1 
...
Install the Azure Event Grid management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.EventGrid --prerelease
```
