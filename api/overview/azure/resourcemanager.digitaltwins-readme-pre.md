---
title: Azure Digital Twins Management client library for .NET
...
---
# Azure Digital Twins Management client library for .NET - version 1.0.0-alpha.20220912.1 
...
Install the Azure Digital Twins management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.DigitalTwins --prerelease
```
