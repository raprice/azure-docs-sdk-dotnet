...
ms.service: eventhub
---
# Azure Event Hubs Event Processor client library for .NET - version 5.8.0-alpha.20220913.1 
...
[Source code](https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/eventhub/Azure.Messaging.EventHubs.Processor/src) | [Package (NuGet)](https://www.nuget.org/packages/Azure.Messaging.EventHubs.Processor/) | [API reference documentation](/dotnet/api/azure.messaging.eventhubs) | [Product documentation](/azure/event-hubs/)
