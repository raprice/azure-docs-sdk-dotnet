---
title: Azure Healthbot Management client library for .NET
...
---
# Azure Healthbot Management client library for .NET - version 1.0.0-alpha.20220914.1 
...
Install the Azure Healthbot management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.Healthbot --prerelease
```
