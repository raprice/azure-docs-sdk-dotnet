---
title: Azure Private Dns Management client library for .NET
...
---
# Azure Private Dns Management client library for .NET - version 1.0.0-alpha.20220916.1 
...
Install the Azure Private Dns management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.PrivateDns --prerelease
```
