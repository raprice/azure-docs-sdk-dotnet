---
title: Azure NetApp Management client library for .NET
...
ms.service: netapp
---
# Azure NetApp Management client library for .NET - version 1.0.0-alpha.20220916.1 
...
```dotnetcli
dotnet add package Azure.ResourceManager.NetApp --prerelease
```
