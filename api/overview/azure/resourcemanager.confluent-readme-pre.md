---
title: Azure Confluent Management client library for .NET
...
---
# Azure Confluent Management client library for .NET - version 1.0.0-alpha.20220912.1 
...
Install the Azure Confluent management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.Confluent --prerelease
```
