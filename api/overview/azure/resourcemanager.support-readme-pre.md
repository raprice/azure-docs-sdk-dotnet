---
title: Azure Support Management client library for .NET
...
ms.service: support
---
# Azure Support Management client library for .NET - version 1.0.0-alpha.20220916.1 
...
Install the Azure Support management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.Support --prerelease
```
