---
title: Azure Consumption Management client library for .NET
...
---
# Azure Consumption Management client library for .NET - version 1.0.0-alpha.20220919.1 
...
Install the Azure Consumption management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.Consumption --prerelease
```
