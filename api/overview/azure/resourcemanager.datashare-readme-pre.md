---
title: Azure Data Share Management client library for .NET
...
---
# Azure Data Share Management client library for .NET - version 1.0.0-alpha.20220913.1 
...
Install the Azure Data Share management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.DataShare --prerelease
```
