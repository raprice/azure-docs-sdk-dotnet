---
title: Azure Relay Management client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.Relay, relay
author: pallavit
ms.author: pallavit
ms.date: 09/12/2022
ms.topic: reference
...
ms.service: relay
---
# Azure Relay Management client library for .NET - version 1.0.0-alpha.20220912.1 
...
Install the Azure Relay management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.Relay --prerelease
```
