---
title: Azure Front Door Management client library for .NET
...
---
# Azure Front Door Management client library for .NET - version 1.0.0-alpha.20220914.1 
...
Install the Azure Front Door management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.FrontDoor --prerelease
```
