---
title: Azure Application Insights Management client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.ApplicationInsights, applicationinsights
author: pallavit
ms.author: pallavit
ms.date: 09/14/2022
ms.topic: reference
...
---
# Azure Application Insights Management client library for .NET - version 1.0.0-alpha.20220914.3 
...
Install the Azure Application Insights management library for .NET with [NuGet](https://www.nuget.org/):
