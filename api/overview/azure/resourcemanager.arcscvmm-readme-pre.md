---
title: Azure Arc ScVmm Management client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.ArcScVmm, arc-scvmm
author: pallavit
ms.author: pallavit
ms.date: 09/14/2022
ms.topic: reference
...
---
# Azure Arc ScVmm Management client library for .NET - version 1.0.0-alpha.20220913.1 
...
Install the Azure Arc ScVmm management library for .NET with [NuGet](https://www.nuget.org/):
