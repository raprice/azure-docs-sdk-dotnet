---
title: Azure AlertsManagement Management client library for .NET
...
---
# Azure AlertsManagement Management client library for .NET - version 1.0.0-alpha.20220912.1 
...
Install the Azure AlertsManagement management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.AlertsManagement --prerelease
```
